        ...
        case 'on-this-week':
            return tasks?.filter(
                item => 
                    ...
                    dayjs(item.createdAt).isSameOrBefore(FILTERS['on-this-week']) && !item.isCompleted
            )
        ...
        case 'on-next-week':
            return tasks?.filter(
                item => 
                    ...
                    dayjs(item.createdAt).isSameOrBefore(FILTERS['on-next-week']) && !item.isCompleted
            )
        ...
        case 'later':
            return tasks?.filter(
                item => 
                    ...
                    !item.createdAt) && !item.isCompleted
            )
